...
#define CUSTOM_MACHINE_NAME "Kossel 1.1.9"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS DELTA_PRINTABLE_RADIUS*0.78
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 401 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 45 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MIN_PROBE_EDGE (DELTA_PRINTABLE_RADIUS - 10)
  #define LEFT_PROBE_BED_POSITION -(MIN_PROBE_EDGE)
  #define RIGHT_PROBE_BED_POSITION MIN_PROBE_EDGE
  #define FRONT_PROBE_BED_POSITION -(MIN_PROBE_EDGE)
  #define BACK_PROBE_BED_POSITION MIN_PROBE_EDGE
  ...
  #define PROBE_PT_1_X _PX(MIN_PROBE_EDGE, 0)   // Probing points for 3-Point leveling of the mesh
  #define PROBE_PT_1_Y _PY(MIN_PROBE_EDGE, 0)
  #define PROBE_PT_2_X _PX(MIN_PROBE_EDGE, 120)
  #define PROBE_PT_2_Y _PY(MIN_PROBE_EDGE, 120)
  #define PROBE_PT_3_X _PX(MIN_PROBE_EDGE, 240)
  #define PROBE_PT_3_Y _PY(MIN_PROBE_EDGE, 240)
...
#define HOMING_FEEDRATE_Z  (200*40)
